...
st.set_page_config(page_title="Perspectives of Vinit", page_icon="img/logo.png",)
...
openai.api_key = os.getenv("type-key-here")
...
def main_gpt3emailgen():
    ...
    st.markdown('Generate professional sounding emails based on your comments - powered by Artificial Intelligence! Implemented by '
        '[Vinit](https://www.linkedin.com/in/vinit-waingankar-0bb31812a/)')
    st.write('\n')  # add spacing

    st.subheader('\nWhat is your email all about?\n')
    with st.expander("SECTION - Email Input", expanded=True):

        input_c1 = st.text_input('Enter email contents down below!', 'topic 1')
        ...
        with col1:
            input_sender = st.text_input('Sender Name', 'Sender')
        with col2:
